...
public extension FontRepresentable where Self.RawValue == String {
    ...
    // TODO: 适配不同字体
    ///
    /// CNUIFont.PingFangSC.cn_fontSize(ofSize: 15, weight: .regular)
    ///
    func cn_fontSize(ofSize: CGFloat) -> UIFont? {
...
public enum CNUIFont: String, FontRepresentable {
    ...
    // 自定义字体
    case FZLanTingHeiS_DB1_GB                 = "FZLanTingHeiS-DB1-GB" // 方正兰亭中粗黑简体
    case FZLTHJW_GB1_0                        = "FZLTHJW--GB1-0" // 兰亭黑简
    case DINCond_Bold                         = "DINCond-Bold"
    case DFPYuanW9                            = "DFPYuanW9"    // 华康圆体W9
